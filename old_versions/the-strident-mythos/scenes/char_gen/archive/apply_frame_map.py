...
# Extract the 'id="..."' part specifically
...
# Replace '1_hedtk' with the extracted texture ID
std_map_modified = [line.replace("1_hedtk", character_texture_id) for line in std_map_lines]
